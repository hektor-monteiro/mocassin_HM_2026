...
#def make_cube(cube):  #recebe o cubo-octante e os tamanhos dos eixos
#    
#    xsize,ysize,zsize = cube.shape
#    
#    full_cub = np.zeros((xsize*2, ysize*2, zsize*2))    
#    full_cub[:xsize,:ysize,:zsize] = np.flip(np.flip(np.flip(cube,2),0),1)    
#    full_cub[xsize:xsize*2,:ysize,:zsize] = np.flip(np.flip(cube,1),2)    
#    full_cub[xsize:xsize*2,ysize:ysize*2,:zsize] = np.flip(cube,2)    
#    full_cub[:xsize,ysize:ysize*2,:zsize] = np.flip(np.flip(cube,2),0)    
#    full_cub[:xsize,:ysize,zsize:zsize*2] = np.flip(np.flip(cube,0),1)    
#    full_cub[xsize:xsize*2,:ysize,zsize:zsize*2] = np.flip(cube,1)    
#    full_cub[xsize:xsize*2,ysize:ysize*2,zsize:zsize*2] = cube    
#    full_cub[:xsize,ysize:ysize*2,zsize:zsize*2] = np.flip(cube,0)
#    
#    return full_cub
